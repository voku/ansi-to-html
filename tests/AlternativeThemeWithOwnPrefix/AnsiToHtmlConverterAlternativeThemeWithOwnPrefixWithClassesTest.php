...
class AnsiToHtmlConverterAlternativeThemeWithOwnPrefixWithClassesTest extends \PHPUnit_Framework_TestCase
{
  /**
...
END_CSS;
    ...
    return [
      // text is escaped
      ['<span class="solarized_bg_black solarized_fg_white">foo &lt;br /&gt;</span>', $css, 'foo <br />'],

      // newlines are preserved
      ["<span class=\"solarized_bg_black solarized_fg_white\">foo\nbar</span>", $css, "foo\nbar"],

      // backspaces
      ['<span class="solarized_bg_black solarized_fg_white">foo   </span>', $css, "foobar\x08\x08\x08   "],
      [
          '<span class="solarized_bg_black solarized_fg_white">foo</span><span class="solarized_bg_black solarized_fg_white">   </span>',
          $css,
          "foob\e[31;41ma\e[0mr\x08\x08\x08   ",
      ],

      // color
      ['<span class="solarized_bg_red solarized_fg_red">foo</span>', $css, "\e[31;41mfoo\e[0m"],

      // color with [m as a termination (equivalent to [0m])
      ['<span class="solarized_bg_red solarized_fg_red">foo</span>', $css, "\e[31;41mfoo\e[m"],

      // bright color
      ['<span class="solarized_bg_brred solarized_fg_brred">foo</span>', $css, "\e[31;41;1mfoo\e[0m"],

      // carriage returns
      ['<span class="solarized_bg_black solarized_fg_white">foobar</span>', $css, "foo\rbar\rfoobar"],

      // underline
      ['<span class="solarized_bg_black solarized_fg_white solarized_underlined">foo</span>', $css, "\e[4mfoo\e[0m"],

      // non valid unicode codepoints substitution (only available with PHP >= 5.4)
      [
          '<span class="solarized_bg_black solarized_fg_white">foo ' . "\xEF\xBF\xBD" . '</span>',
          $css,
          "foo \xF4\xFF\xFF\xFF",
      ],

      // Yellow on green.
      ['<span class="solarized_bg_green solarized_fg_yellow">foo</span>', $css, "\e[33;42mfoo\e[0m"],

      // Yellow on green - reversed.
      ['<span class="solarized_bg_yellow solarized_fg_green">foo</span>', $css, "\e[33;42;7mfoo\e[0m"],
    ];
  }
}
