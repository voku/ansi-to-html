...
class AnsiToHtmlConverterAlternativeThemeWithOwnPrefixWithAlternativeCSSPrefixTest extends \PHPUnit_Framework_TestCase
{
  /**
...
END_CSS;
    ...
    return [
      // text is escaped
      ['<span class="dalek_bg_black dalek_fg_white">foo &lt;br /&gt;</span>', $css, 'foo <br />'],

      // newlines are preserved
      ["<span class=\"dalek_bg_black dalek_fg_white\">foo\nbar</span>", $css, "foo\nbar"],

      // backspaces
      ['<span class="dalek_bg_black dalek_fg_white">foo   </span>', $css, "foobar\x08\x08\x08   "],
      [
          '<span class="dalek_bg_black dalek_fg_white">foo</span><span class="dalek_bg_black dalek_fg_white">   </span>',
          $css,
          "foob\e[31;41ma\e[0mr\x08\x08\x08   ",
      ],

      // color
      ['<span class="dalek_bg_red dalek_fg_red">foo</span>', $css, "\e[31;41mfoo\e[0m"],

      // color with [m as a termination (equivalent to [0m])
      ['<span class="dalek_bg_red dalek_fg_red">foo</span>', $css, "\e[31;41mfoo\e[m"],

      // bright color
      ['<span class="dalek_bg_brred dalek_fg_brred">foo</span>', $css, "\e[31;41;1mfoo\e[0m"],

      // carriage returns
      ['<span class="dalek_bg_black dalek_fg_white">foobar</span>', $css, "foo\rbar\rfoobar"],

      // underline
      ['<span class="dalek_bg_black dalek_fg_white dalek_underlined">foo</span>', $css, "\e[4mfoo\e[0m"],

      // non valid unicode codepoints substitution (only available with PHP >= 5.4)
      [
          '<span class="dalek_bg_black dalek_fg_white">foo ' . "\xEF\xBF\xBD" . '</span>',
          $css,
          "foo \xF4\xFF\xFF\xFF",
      ],

      // Yellow on green.
      ['<span class="dalek_bg_green dalek_fg_yellow">foo</span>', $css, "\e[33;42mfoo\e[0m"],

      // Yellow on green - reversed.
      ['<span class="dalek_bg_yellow dalek_fg_green">foo</span>', $css, "\e[33;42;7mfoo\e[0m"],
    ];
  }
}
